...
const ListUpdatePopup: React.FC<ListUpdatePopupProps> = ({ popKey, listUrl, oldList, newList, auto }) => {
			...
			<AutoColumn style={{ flex: '1' }} gap="8px">
				{auto ? (
					...
					<>
						<div>
							<Text>
								An update is available for the token list &quot;{oldList.name}&quot; ({listVersionLabel(oldList.version)} to{' '}
