...
const CandleChart: React.FC<LineChartProps> = ({
	data,
	color = '#56B2A4',
	setValue,
	setLabel,
	...
	useEffect(() => {
		if (!chartCreated && data && Boolean(chartRef?.current?.parentElement)) {
			const chart = createChart(chartRef.current!, {
				height,
				width: chartRef?.current?.parentElement?.clientWidth ? chartRef.current.parentElement.clientWidth - 32 : 0,
				layout: {
